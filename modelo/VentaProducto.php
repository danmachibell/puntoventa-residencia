...
class VentaProducto{
    ...
    function ver($id){
        $sql="SELECT venta_producto.precio as precio,cantidad,producto.nombre as producto,concentracion,adicional, presentacion.nombre as presentacion, tipo_producto.nombre as tipo, subtotal
        FROM venta_producto
