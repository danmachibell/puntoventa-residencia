...
if($_POST['funcion']=='crear'){
    ...
    $producto->crear($nombre,$concentracion,$adicional,$precio,$tipo,$presentacion,$avatar);
}
if($_POST['funcion']=='editar'){
    ...
    $tipo = $_POST['tipo'];
    $presentacion = $_POST['presentacion'];
    $producto->editar($id,$nombre,$concentracion,$adicional,$precio,$tipo,$presentacion);
}
...
if($_POST['funcion']=='rellenar_productos'){
    ...
    foreach ($producto->objetos as $objeto) {
        ...
        $json[]=array(
            ...
            'nombre'=>$objeto->id_producto.' | '.$objeto->nombre.' | '.$objeto->concentracion.' | '.$objeto->adicional.' |  '.$objeto->presentacion
        );
    }
    $jsonstring = json_encode($json);
    echo $jsonstring;
